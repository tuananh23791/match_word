...
import 'package:match_work/page/home/home_screen.dart';
import 'package:match_work/page/login/login_bindings.dart';
import 'package:match_work/page/login/login_screen.dart';
import 'package:match_work/page/register/register_bindings.dart';
...
GetMaterialApp router(){
  return GetMaterialApp(
    ...
    getPages: [
      ...
      GetPage(name: REGISTER_SCREEN, page: () => RegisterScreen(), binding: RegisterBindings()),
      GetPage(name: HOME_SCREEN, page: () => HomeScreen(), binding: RegisterBindings()),
